<x-app-layout>
    <div class="container mx-auto px-20 max-md:px-4 py-8">
        ...
        <form method="POST" action="{{ route('user.store', ['user_id' => Auth::id()]) }}" class="">
            ...
            <div class="flex mt-8">
                <button type="submit"
                    class="text-center w-full py-3 bg-[#40534C] text-white font-bold rounded-md hover:bg-[#C9DABF] hover:text-[#40534C] hover:border-2 hover:border-[#40534C]">
                    Simpan
                </button>
            </div>
        </form>
    ...
    <script>
        ...
        function addChildField() {
            ...
            const newChildFields = `<div class="border-t-2 mt-16 border-[#40534C] max-md:mt-8">
        <div class="child-fields flex flex-wrap -mx-4 mb-6 pt-16 max-md:pt-8">
            <div class="w-full md:w-1/2 px-4 max-md:mb-6">
                ...
                <input type="text" id="name_child_${index}" name="name_child[]" class="form-input mt-1 block w-full text-black border-[#40534C] bg-gray-100 rounded-md shadow-sm focus:border-[#40534C] focus:ring focus:ring-[#40534C] focus:ring-opacity-50">
            </div>
            <div class="w-full md:w-1/2 px-4">
                <label for="birth_child_${index}" class="block text-gray-700 font-medium mb-2">Tempat Tanggal Lahir</label>
                <input type="text" id="birth_child_${index}" name="birth_child[]" class="form-input mt-1 block w-full text-black border-[#40534C] bg-gray-100 rounded-md shadow-sm focus:border-[#40534C] focus:ring focus:ring-[#40534C] focus:ring-opacity-50">
            </div>
        </div>
        <div class="flex flex-wrap -mx-4 mb-6">
            <div class="w-full md:w-1/2 px-4 max-md:mb-6">
                <label for="gender_child_${index}" class="block text-gray-700 font-medium mb-2">Jenis Kelamin</label>
                <select id="gender_child_${index}" name="gender_child[]" class="form-select mt-1 block w-full py-2 px-4 text-black border-[#40534C] bg-gray-100 rounded-md shadow-sm focus:border-[#40534C] focus:ring focus:ring-[#40534C] focus:ring-opacity-50">
                    <option value="">Pilih Jenis Kelamin</option>
                    <option value="Laki-Laki">Laki-Laki</option>
                    <option value="Perempuan">Perempuan</option>
                </select>
            ...
            <div class="w-full md:w-1/2 px-4">
                ...
                <select id="status_child_${index}" name="status_child[]" onchange="toggleSpouseAndChildrenFields()" class="form-select mt-1 block w-full py-2 px-4 text-black border-[#40534C] bg-gray-100 rounded-md shadow-sm focus:border-[#40534C] focus:ring focus:ring-[#40534C] focus:ring-opacity-50">
                    <option value="">Pilih Status</option>
                    <option value="Menikah">Menikah</option>
                    <option value="Belum Menikah">Belum Menikah</option>
                </select>
        ...
        <div class="flex flex-wrap -mx-4 mb-6">
            <div class="w-full md:w-1/2 px-4 max-md:mb-6">
                ...
                <select id="blood_child_${index}" name="blood_child[]" class="form-select mt-1 block w-full py-2 px-4 text-black bg-gray-100 border-[#40534C] rounded-md shadow-sm focus:border-[#40534C] focus:ring focus:ring-[#40534C] focus:ring-opacity-50">
                    <option value="">Pilih Golongan Darah</option>
                    <option value="A">A</option>
                    <option value="B">B</option>
                    <option value="AB">AB</option>
            ...
            <div class="w-full md:w-1/2 px-4">
                ...
                <select id="religion_child_${index}" name="religion_child[]" class="form-select mt-1 block w-full py-2 px-4 text-black bg-gray-100 border-[#40534C] rounded-md shadow-sm focus:border-[#40534C] focus:ring focus:ring-[#40534C] focus:ring-opacity-50">
                    <option value="">Pilih Agama</option>
                    <option value="Islam">Islam</option>
                    <option value="Kristen">Kristen</option>
                    <option value="Katolik">Katolik</option>
        ...
        <div class="flex flex-wrap -mx-4 mb-6">
            <div class="w-full md:w-1/2 px-4 max-md:mb-6">
                ...
                <input type="text" id="phone_child_${index}" name="phone_child[]" class="form-input mt-1 block w-full text-black border-[#40534C] bg-gray-100 rounded-md shadow-sm focus:border-[#40534C] focus:ring focus:ring-[#40534C] focus:ring-opacity-50">
            </div>
            <div class="w-full md:w-1/2 px-4">
                <label for="job_child_${index}" class="block text-gray-700 font-medium mb-2">Pekerjaan</label>
                <input type="text" id="job_child_${index}" name="job_child[]" class="form-input mt-1 block w-full text-black border-[#40534C] bg-gray-100 rounded-md shadow-sm focus:border-[#40534C] focus:ring focus:ring-[#40534C] focus:ring-opacity-50">
            </div>
        </div>
        <div class="flex flex-wrap -mx-4 mb-6">
            <div class="w-full md:w-1/2 px-4 max-md:mb-6">
