    ...
    <div
        ...
        <form method="POST" action="{{ route('register') }}" class="w-80">
            ...
            <div class="mb-4 w-full">
                <label class="block font-medium text-sm text-[#D6EFD8] md:text-[#40534C]" for="name">
                    Name
                </label>
                <input
                    class="border-[#40534C] bg-[#f5f5f5] focus:border-[#40534C] focus:ring-[#40534C] max-md:focus:border-[#80AF81] max-md:focus:ring-[#80AF81] rounded-md shadow-sm"
                    id="name" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" placeholder="name">
                <x-input-error :messages="$errors->get('name')" class="mt-2" />
            </div>
        
            <div class="mb-4 w-full">
                <label class="block font-medium text-sm text-[#D6EFD8] md:text-[#40534C]" for="email">
                    Email
                </label>
                <input
                    class="border-[#40534C] bg-[#f5f5f5] focus:border-[#40534C] focus:ring-[#40534C] max-md:focus:border-[#80AF81] max-md:focus:ring-[#80AF81] rounded-md shadow-sm"
            ...
            <div class="mb-4 w-full">
                <label class="block font-medium text-sm text-[#D6EFD8] md:text-[#40534C]" for="password">
                    Password
                </label>
                <input
                    class="border-[#40534C] bg-[#f5f5f5] focus:border-[#40534C] focus:ring-[#40534C] max-md:focus:border-[#80AF81] max-md:focus:ring-[#80AF81] rounded-md shadow-sm"
            ...
            <div class="mb-6 w-full">
                <label class="block font-medium text-sm text-[#D6EFD8] md:text-[#40534C]" for="password_confirmation">
                    Confirm Password
                </label>
                <input
                    class="border-[#40534C] bg-[#f5f5f5] focus:border-[#40534C] focus:ring-[#40534C] max-md:focus:border-[#80AF81] max-md:focus:ring-[#80AF81] rounded-md shadow-sm"
