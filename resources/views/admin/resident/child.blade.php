        ...
        <div class="max-w-full flex-grow">
            <div class="flex justify-between items-center mb-6 max-md:mb-4">
                <div class="font-Poppins">
                    <h1 class="text-4xl text-[#475569] font-medium pb-2 max-md:text-lg max-md:pb-0">Data Anak</h1>
                </div>
                            ...
                            <tbody>
                                @foreach ($children as $index => $child)
                                    <tr class="bg-white border-b">
                                        ...
                                        <td class="px-6 py-4">{{ $child->name_child }}</td>
                                        <td class="px-6 py-4">{{ $child->resident->name }}</td> <!-- Nama Ayah -->
                                        <td class="px-6 py-4">{{ $child->gender_child }}</td>
                                        <td class="px-6 py-4">{{ $child->birth_child }}</td>
                                        <td class="px-6 py-4">{{ $child->status_child }}</td>
                                        <td class="px-6 py-4">{{ $child->blood_child }}</td>
                                        <td class="px-6 py-4">{{ $child->phone_child }}</td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
